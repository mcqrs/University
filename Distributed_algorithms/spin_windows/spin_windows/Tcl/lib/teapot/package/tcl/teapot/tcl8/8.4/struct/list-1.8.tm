...
# Meta subject         {right outer join} differential map flatten
# Meta subject         {first permutation} join equal swapping diff
# Meta subject         {full outer join} repetition folding subsequence
# Meta subject         {inner join} reshuffle Fisher-Yates shuffle assign
# Meta subject         {generate permutations} equality filter
# Meta subject         {next permutation} {outer join} repeating
