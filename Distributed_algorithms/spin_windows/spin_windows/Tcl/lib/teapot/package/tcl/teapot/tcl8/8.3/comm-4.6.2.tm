...
# Meta subject         {remote execution} {remote communication} ssl ipc
# Meta subject         comm message comm ipc {remote execution} rpc message
# Meta subject         socket communication {remote communication}
