...
# Meta category        ftp client
# Meta description     Client-side tcl implementation of the ftp protocol
# Meta license         BSD
# Meta platform        tcl
# Meta require         {Tcl 8.2}
# Meta require         log
# Meta subject         internet {rfc 959} ftp net
# Meta summary         ftp
# @@ Meta End
