...
# set CC   "cl -w -nologo"	;# Visual Studio C/C++ compiler, prefered on PCs
  set CC   "gcc.exe -w"		;# standard gcc compiler - no warnings
  set CC0  "gcc.exe"

# set CPP  "cpp"		;# the default C preprocessor
  set CPP  "gcc.exe -E -x c"	;# c preprocessor, assuming we have gcc

  set SPIN "spin.exe"	;# use a full path-name if necessary, e.g. c:/cygwin/bin/spin.exe
